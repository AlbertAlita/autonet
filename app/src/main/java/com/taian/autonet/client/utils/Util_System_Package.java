...
public class Util_System_Package {
    ...
    public static boolean installSlient(Context context, String apkPath) {
        try {
            ...
            Log.e("installSlient","before");
            ShellUtils.CommandResult commandResult = ShellUtils.execCommand(command.toString(), !isSysApp, true);
            Log.e("installSlient",commandResult.errorMsg + "-----" + commandResult.successMsg);
