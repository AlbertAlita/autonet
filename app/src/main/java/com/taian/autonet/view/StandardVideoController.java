package com.taian.autonet.view;
...
//        addControlComponent( errorView, prepareView, titleView);
    ...
    private PlayStateChangedListener listener;

    public void setListener(PlayStateChangedListener listener) {
